    ...
    <>
      ...
      <div className="mt-14 grid gap-6">
        <div className="relative h-48">
          ...
          <p className="mt-2">👋 Send me an email at <Link href='mailto:contact@fabgallo.com'><a className="transition-colors duration-150 hover:text-primary-600 hover:underline">contact@fabgallo.com</a></Link> or connect with me via <Link href='https://linkedin.com/in/fabgallo'><a className="transition-colors duration-150 hover:text-primary-600 hover:underline"><FiLinkedin className="inline-block mt-[-5px]" /> LinkedIn</a></Link>.</p>
        </div>
      </div>
    </>
  );
