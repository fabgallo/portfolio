          ...
          {reviews.map((review, index) => (
            <div className="mb-6" key={index}>
              <div className="flex flex-col items-center">
                {review.author.imageUrl && (<div className="h-24 w-24 rounded-full">
                ...
                <div className="whitespace-pre-wrap mt-6 max-w-2xl rounded-2xl bg-white p-8 text-gray-500 shadow-lg dark:bg-gray-700 dark:text-gray-200">
                  {review.comment}
                </div>
              </div>
            </div>
